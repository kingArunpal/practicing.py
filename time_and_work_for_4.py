...
x=float(input("enter number of days taken by A to complet the work "))
y=float(input("enter number of days taken by B to complet the work "))
z=float(input("enter number of days taken by C to complet the work "))
H=float(input("enter number of days taken by D to complet the work "))
